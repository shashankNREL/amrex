...
amrex::Real distFcnElement2d::cpdist(amrex::RealArray pt,
                                     amrex::RealVect & cpmin) const {
  amrex::Abort("cp dist must be implemented by the derived class");
}


amrex::Real distFcnElement2d::cpside(amrex::RealArray pt,
                                     amrex::RealVect & cpmin) const {
...
amrex::Real SplineDistFcnElement2d::cpdist(amrex::RealArray pt,
                                           amrex::RealVect & cpmin) const {
...
amrex::Real SplineDistFcnElement2d::cpside(amrex::RealArray pt,
...
void SplineDistFcnElement2d::single_spline_cpdist(amrex::RealArray pt,
                                    amrex::Real x0, amrex::Real x1,
                                    amrex::Real Dx0, amrex::Real Dx1,
                                    amrex::Real y0, amrex::Real y1,
                                    amrex::Real Dy0, amrex::Real Dy1,
  ...
  for (int i=0; i<maxIters; ++i) {
    ...
    deltapt[0] =  spt[0] - pt[0];
    deltapt[1] =  spt[1] - pt[1];
  ...
  if (mindist == 0.0) {
    std::cout << "identified minimum distance of 0.0 at t = " << t
              << "; cp = " << mincp[0] << " for p = " << pt[0] << std::endl;
  }
  return;
}
...
/* ---------------------------------------------------------------------------*/
amrex::Real LineDistFcnElement2d::cpdist(amrex::RealArray pt,
                                         amrex::RealVect & cpmin) const {
...
amrex::Real LineDistFcnElement2d::cpside(amrex::RealArray pt,
                                         amrex::RealVect & cpmin) const {
...
void LineDistFcnElement2d::single_seg_cpdist(amrex::RealArray pt,
                                             amrex::Real x0, amrex::Real x1,
                                             amrex::Real y0, amrex::Real y1,
                                             amrex::RealVect& cp,
